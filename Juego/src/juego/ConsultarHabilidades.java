 ...
 * @author vchin
 */
public class ConsultarHabilidades extends javax.swing.JDialog {

    private Controlador controlHabilidad;

    /**
     * Creates new form ConsultarHabilidades
     */
    public ConsultarHabilidades(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public ConsultarHabilidades(java.awt.Frame parent, boolean modal, Controlador elControl) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitulo1.setText("Consultar Habilidades");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/habilidad.gif"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarHabilidades.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultarHabilidades dialog = new ConsultarHabilidades(new javax.swing.JFrame(), true);
